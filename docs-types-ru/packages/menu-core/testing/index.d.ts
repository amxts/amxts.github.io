import type { ArgValue, FakePlayer, FakeServer, Memory, NativeResult } from "@amxts/core/test-utils";
...
export declare function menusOf(server: FakeServer): MenuKit;
declare const _default: import("@amxts/core/test-utils").TestKit<MenuKit>;
