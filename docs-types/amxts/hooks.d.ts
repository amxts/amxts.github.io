...
export declare class AddAccountEvent extends HookEvent {
    ...
    /** What for: "roundBonus", "enemyKilled", "playerBoughtSomething", "hostageRescued", ... */
...
export declare class AddResourceEvent extends HookEvent {
    private readonly kind;
    /** What kind of file: "sound", "model", "decal", "generic", ... */
...
export declare class BuyWeaponByWeaponIdEvent extends HookEvent {
    ...
    /** The player the event is about. */
    get player(): Player;
    /** Which weapon, as weapon.kind names it: "ak47", "awp", ... */
...
/**
 * Whether one player hears another on voice. Return true or false to decide.
 *
...
/**
 * Whether a player may move to a team. Return true or false to decide.
 *
...
/**
 * The game checks whether a side has won. preventDefault() stops it from ending the round.
 *
...
export declare class ChooseTeamEvent extends HookEvent {
    ...
    /** The player the event is about. */
    get player(): Player;
    /** What he picked: "TERRORIST", "CT", "VIP", "auto" or "SPECTATOR". Assign to change it. */
...
/**
 * The game hands a spawned player his default weapons. preventDefault() gives nothing.
 *
...
/**
 * Whether an item is forbidden to a player. Return true to forbid it.
 *
...
export declare class HasRestrictItemEvent extends HookEvent {
    ...
    get item(): Weapon;
    /** How he would get it: "buying", "touched" (picked up) or "equipped" (given on spawn). */
...
export declare class HintMessageExEvent extends HookEvent {
    ...
    /** Shown even to a player who turned hints off. */
...
export declare class OnEventEvent extends HookEvent {
    private readonly kind;
    /** What happened: "weaponFired", "playerDied", "bombPlanted", "roundStart", ... */
...
/**
 * A flashbang is blinding a player. preventDefault() keeps his eyes clear.
 *
...
export declare class PlayerBlindEvent extends HookEvent {
    ...
    get alpha(): number;
    set alpha(value: number);
    /** The colour of the flash, [r, g, b] as a Vector. Read only. */
    get color(): Vector;
}
/**
...
/**
 * Every frame, for every player, before he moves - hundreds of times a second. Keep it tiny.
 *
...
/**
 * The game resets a player's speed - on spawn and every weapon switch. preventDefault() keeps the speed you set.
 *
...
export declare class RoundEndEvent extends HookEvent {
    private readonly kind;
    /** Who won: "TERRORIST", "CT", "draw" or "none" - as game.endRound takes it. Assign to change it. */
    get winner(): RoundWinner;
    set winner(value: RoundWinner);
    /** Why the round ended: "terroristsWin", "ctsWin", "bombDefused", "targetSaved", "gameRestart", ... "unknown" for a number the game does not name. */
...
export declare class SendDeathMessageEvent extends HookEvent {
    ...
    /** What else the message carries: "Position", "Assistant", "KillRarity". */
    get flags(): DeathMessageFlag[];
    set flags(values: DeathMessageFlag[]);
    /** What made the kill rare: "Headshot", "NoScope", "Penetrated", "InAir", ... */
...
export declare class ShowVguiMenuEvent extends HookEvent {
    ...
    /** The player the event is about. */
    get player(): Player;
    /** Which menu: "team", "classT", "classCT", "buy", "buyPistol", ... */
    get menu(): VguiMenu;
...
/**
 * A sound is about to play. Assign event.sample to change it, or preventDefault() to keep it silent.
 *
...
export declare class TakeDamageEvent extends HookEvent {
    ...
    /** Who is hurt. */
    get player(): Player;
    /** What hurt him: a weapon, a grenade, the world. */
    get inflictor(): Entity;
    /** Who hurt him. */
    get attacker(): Player;
    /** How much, before armour. Assign to change it. */
    get damage(): number;
    set damage(value: number);
    /** What kind of damage: "Fall", "Bullet", "Burn", ... */
    get damageType(): Damage[];
    set damageType(values: Damage[]);
    /** What the game answered (`int`) - read it in a post hook. To answer, return a value from the handler. */
    get result(): number;
...
export declare class ThrowGrenadeEvent extends HookEvent {
    ...
    /** `Float:vecSrc[3]` - argument 3, read only. */
    get src(): Vector;
    /** Its velocity, a Vector. Read only. */
    get velocity(): Vector;
...
export declare class ThrowHeGrenadeEvent extends HookEvent {
    ...
    /** Who threw it. */
    get player(): Player;
    /** Where the grenade starts, a Vector. Read only. */
    get start(): Vector;
    /** Its velocity, a Vector. Read only. */
    get velocity(): Vector;
    /** `Float:time` - argument 4. */
...
export declare class TraceAttackEvent extends HookEvent {
    ...
    get damage(): number;
    set damage(value: number);
    /** The direction of the shot, a Vector. Read only. */
    get dir(): Vector;
...
export interface GameEventMap {
    ...
    /** A player's money changes. Assign event.amount to change how much. - reapi `RG_CBasePlayer_AddAccount`. */
    ...
    /** A file is added to what clients download. - reapi `RH_SV_AddResource`. */
    ...
    /** A player buys a weapon. In a post listener event.result is the weapon. - reapi `RG_BuyWeaponByWeaponID`. */
    ...
    /** Whether one player hears another on voice. Return true or false to decide. - reapi `RG_CSGameRules_CanPlayerHearPlayer`. */
    canPlayerHearPlayer: CanPlayerHearPlayerEvent;
    /** Whether a player may move to a team. Return true or false to decide. - reapi `RG_CBasePlayer_CanSwitchTeam`. */
    ...
    /** The game checks whether a side has won. preventDefault() stops it from ending the round. - reapi `RG_CSGameRules_CheckWinConditions`. */
    checkWinConditions: CheckWinConditionsEvent;
    /** reapi `RG_HandleMenu_ChooseAppearance`. */
    chooseAppearance: ChooseAppearanceEvent;
    /** A player picked an item in the team menu. preventDefault() ignores the pick. - reapi `RG_HandleMenu_ChooseTeam`. */
    ...
    /** A weapon is being taken out. Assign event.viewModel / weaponModel to change what is shown. - reapi `RG_CBasePlayerWeapon_DefaultDeploy`. */
    ...
    /** A player drops a weapon. In a post listener event.result is the weapon box on the ground. - reapi `RG_CBasePlayer_DropPlayerItem`. */
    ...
    /** A smoke grenade is going off. - reapi `RG_CGrenade_ExplodeSmokeGrenade`. */
    ...
    /** The game works out how much a fall hurts. In a post listener event.result is that number; return a number to replace it. - reapi `RG_CSGameRules_FlPlayerFallDamage`. */
    ...
    /** reapi `RG_CSGameRules_GiveC4`. */
    giveC4: GiveC4Event;
    /** The game hands a spawned player his default weapons. preventDefault() gives nothing. - reapi `RG_CBasePlayer_GiveDefaultItems`. */
    ...
    /** Whether an item is forbidden to a player. Return true to forbid it. - reapi `RG_CBasePlayer_HasRestrictItem`. */
    hasRestrictItem: HasRestrictItemEvent;
    /** The game shows a player a hint. - reapi `RG_CBasePlayer_HintMessageEx`. */
    hintMessageEx: HintMessageExEvent;
    /** A player sends an impulse: 100 is the flashlight, 201 the spray. - reapi `RG_CBasePlayer_ImpulseCommands`. */
    ...
    /** The game tells the bots something happened. - reapi `RG_CBotManager_OnEvent`. */
    onEvent: OnEventEvent;
    /** The freeze time at the start of the round is over. - reapi `RG_CSGameRules_OnRoundFreezeEnd`. */
    ...
    /** A flashbang is blinding a player. preventDefault() keeps his eyes clear. - reapi `RG_PlayerBlind`. */
    ...
    /** A player was killed. - reapi `RG_CSGameRules_PlayerKilled`. */
    playerKilled: PlayerKilledEvent;
    /** A player spawned. - reapi `RG_CSGameRules_PlayerSpawn`. */
    ...
    /** Every frame, for every player, before he moves - hundreds of times a second. Keep it tiny. - reapi `RG_CBasePlayer_PreThink`. */
    ...
    printf: PrintfEvent;
    /** A radio message is sent. preventDefault() silences it. - reapi `RG_CBasePlayer_Radio`. */
    radio: RadioEvent;
    ...
    /** The game resets a player's speed - on spawn and every weapon switch. preventDefault() keeps the speed you set. - reapi `RG_CBasePlayer_ResetMaxSpeed`. */
    resetMaxSpeed: ResetMaxSpeedEvent;
    /** reapi `RG_CBaseAnimating_ResetSequenceInfo`. */
    resetSequenceInfo: ResetSequenceInfoEvent;
    /** A new round is starting. - reapi `RG_CSGameRules_RestartRound`. */
    restartRound: RestartRoundEvent;
    /** The round is ending. - reapi `RG_RoundEnd`. */
    roundEnd: RoundEndEvent;
    /** reapi `RG_CBasePlayer_RoundRespawn`. */
    roundRespawn: RoundRespawnEvent;
    /** The game tells everyone who killed whom. - reapi `RG_CSGameRules_SendDeathMessage`. */
    ...
    /** The game shows a player a menu. - reapi `RG_ShowMenu`. */
    showMenu: ShowMenuEvent;
    /** The game shows a player a VGUI menu (team select). - reapi `RG_ShowVGUIMenu`. */
    ...
    /** A dead player's camera starts. - reapi `RG_CBasePlayer_StartDeathCam`. */
    ...
    /** A sound is about to play. Assign event.sample to change it, or preventDefault() to keep it silent. - reapi `RH_SV_StartSound`. */
    ...
    /** A player is about to take damage. Return a number to set how much he takes, or call preventDefault() to take none. - reapi `RG_CBasePlayer_TakeDamage`. */
    ...
    think: ThinkEvent;
    /** A player threw a flashbang. In a post listener event.result is the grenade. - reapi `RG_ThrowFlashbang`. */
    throwFlashbang: ThrowFlashbangEvent;
    /** A player throws a grenade. - reapi `RG_CBasePlayer_ThrowGrenade`. */
    throwGrenade: ThrowGrenadeEvent;
    /** A player threw an HE grenade. In a post listener event.result is the grenade. - reapi `RG_ThrowHeGrenade`. */
    throwHeGrenade: ThrowHeGrenadeEvent;
    /** A player threw a smoke grenade. In a post listener event.result is the grenade. - reapi `RG_ThrowSmokeGrenade`. */
    throwSmokeGrenade: ThrowSmokeGrenadeEvent;
    /** A shot or a knife hit a player, before the damage. preventDefault() makes it miss. - reapi `RG_CBasePlayer_TraceAttack`. */
