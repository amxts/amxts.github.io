---
title: "Config Core"
description: "INI-конфиги: секции, типизированные значения, пути в блоки"
---

INI-файлы с `[секциями]`, строками `ключ = значение`, строками из нескольких значений и блоками `ключ = { ... }`: читаются в память и пишутся обратно вместе с комментариями и пустыми строками.
